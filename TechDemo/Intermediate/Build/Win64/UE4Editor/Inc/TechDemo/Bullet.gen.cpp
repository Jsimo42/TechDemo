...
// Cross Module References
	...
	TECHDEMO_API UClass* Z_Construct_UClass_ABullet();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABullet_Statics::NewProp_projectileMoveComponent_MetaData[] = {
		{ "Category", "Movement" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Bullet.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABullet_Statics::NewProp_projectileMoveComponent = { "projectileMoveComponent", nullptr, (EPropertyFlags)0x00100000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABullet, projectileMoveComponent), Z_Construct_UClass_UProjectileMovementComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABullet_Statics::NewProp_projectileMoveComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABullet_Statics::NewProp_projectileMoveComponent_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABullet, 260886119);
	template<> TECHDEMO_API UClass* StaticClass<ABullet>()
	{
		return ABullet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABullet(Z_Construct_UClass_ABullet, &ABullet::StaticClass, TEXT("/Script/TechDemo"), TEXT("ABullet"), false, nullptr, nullptr, nullptr);
